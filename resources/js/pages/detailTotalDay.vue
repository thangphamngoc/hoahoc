        ...
        >
          <div class="form-row">
            <div class="col-md-3 mb-3">
              <label>Chọn nick fb </label>
              <select
                class="form-select form-select-lg col-md-12"
                style="padding: 5px 0 6px 5px"
                v-model="dataCreate.nick_name"
              >
                <option v-for="item in responseList" :value="item">
                  {{ item.nick_name }}
                </option>
              </select>
            </div>
            <div class="col-md-2 mb-2" prop="nick_name">
              <label>Số lượng </label>
              <input
                type="number"
                v-model="dataCreate.to_number"
                class="form-control"
            ...
            <div class="col-md-2 mb-2" prop="nick_name">
              <label>Số lượng mời vào group </label>
              <input
                type="number"
                v-model="dataCreate.to_number_group"
                class="form-control"
                aria-describedby="emailHelp"
                placeholder="Nhập số lượng"
                required
